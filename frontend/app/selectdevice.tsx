...
import { deviceImages } from "../assets"; // ensure this exports miniSensoPair & sensoPair
...
const SelectDeviceScreen: React.FC = () => {
  ...
  const handleDeviceSelect = (deviceName: string) => {
    ...
    // navigation/pairing logic here
    // router.push(`/pairing/${deviceName}`);
  };
    ...
    <LinearGradient colors={["#EAF3EC", "#EEF6EF"]} style={styles.container}>
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <View style={styles.headerWrap}>
          <Text style={styles.headerTitle}>Select device to pair</Text>
          ...
          >
            <View style={styles.innerWrap}>
              <View style={styles.imgBoxMini}>
                <Image
                  source={deviceImages.miniSensoPair}
            ...
            <View style={styles.nameWrap}>
              <Text style={styles.deviceName}>Mini Senso</Text>
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={styles.innerWrap}>
              <View style={styles.imgBox}>
                <Image
                  source={deviceImages.sensoPair}
                  style={styles.deviceImage1}
                  resizeMode="cover"
                />
              </View>
            </View>
            ...
            <View style={styles.nameWrap}>
              <Text style={styles.deviceName}>Senso 1</Text>
            </View>
          </TouchableOpacity>
        </View>
      </SafeAreaView>
